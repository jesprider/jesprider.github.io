...
function init() { 
  ...
  document.getElementById("js-left").onmousedown = function(){
      dir = "left";
      player.isMovingLeft = true;
  };

   document.getElementById("js-right").onmousedown = function(){
      dir = "right";
      player.isMovingRight = true;
   };

  document.getElementById("js-left").onmouseup = function(){
      dir = "left";
      player.isMovingLeft = false;
  };

  document.getElementById("js-right").onmouseup = function(){
      dir = "right";
